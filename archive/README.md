...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
  <div class="rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
    <a href="/archive/meaningalignment.org"><img src="https://screenshotit.app/https://www.meaningalignment.org/" alt="Meaning Alignment Institute screenshot" class="w-full h-48 object-cover object-top" /></a>
    <div class="p-4">
      <h3 class="font-semibold text-base"><a href="/archive/meaningalignment.org" class="hover:underline">MeaningAlignment.org</a></h3>
      <p class="text-sm text-gray-600 mt-1">Clean, minimal research site with thoughtful information architecture — card-based portfolio, clear team structure, content-first.</p>
      <a href="https://www.meaningalignment.org" class="text-xs text-blue-500 mt-2 block">meaningalignment.org →</a>
    </div>
  </div>
  <div class="rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
    <a href="/archive/claude.com-product-overview"><img src="https://screenshotit.app/https://claude.com/product/overview" alt="Claude.com screenshot" class="w-full h-48 object-cover object-top" /></a>
    <div class="p-4">
  ...
  <div class="rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
    <a href="/archive/conductor.build"><img src="../assets/conductor-build.jpg" alt="Conductor.build screenshot" class="w-full h-48 object-cover object-top" /></a>
    <div class="p-4">
  ...
  <div class="rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
    <a href="/archive/interludeapp.net"><img src="../assets/interludeapp.net.jpg" alt="InterludeApp.net screenshot" class="w-full h-48 object-cover object-top" /></a>
    <div class="p-4">
  ...
  <div class="rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
    <a href="/archive/mobbin.com"><img src="https://screenshotit.app/https://mobbin.com/" alt="Mobbin.com screenshot" class="w-full h-48 object-cover object-top" /></a>
    <div class="p-4">
  ...
  <div class="rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
    <a href="/archive/nan.fyi"><img src="https://github.com/user-attachments/assets/e6b4ea19-9d47-4252-9c1c-67f575902f6b" alt="Nan.fyi screenshot" class="w-full h-48 object-cover object-top" /></a>
    <div class="p-4">
  ...
  <div class="rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
    <a href="/archive/nuraform.com"><img src="../assets/nuraform.com.jpg" alt="Nuraform.com screenshot" class="w-full h-48 object-cover object-top" /></a>
    <div class="p-4">
  ...
  <div class="rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
    <a href="/archive/previewlinks.io"><img src="https://github.com/user-attachments/assets/eec2c667-95f3-465e-9a7a-6cd927b24841" alt="PreviewLinks.io screenshot" class="w-full h-48 object-cover object-top" /></a>
    <div class="p-4">
  ...
  <div class="rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
    <a href="/archive/raindrop.ai"><img src="../assets/raindrop.ai.jpg" alt="Raindrop.ai screenshot" class="w-full h-48 object-cover object-top" /></a>
    <div class="p-4">
  ...
  <div class="rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
    <a href="/archive/rywalker.com"><img src="https://screenshotit.app/https://rywalker.com/" alt="RyWalker.com screenshot" class="w-full h-48 object-cover object-top" /></a>
    <div class="p-4">
  ...
  <div class="rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
    <a href="/archive/infuse.univ-amu.fr"><img src="../assets/infuse.univ-amu.fr.png" alt="infuse.univ-amu.fr screenshot" class="w-full h-48 object-cover object-top" /></a>
    <div class="p-4">
      <h3 class="font-semibold text-base"><a href="/archive/infuse.univ-amu.fr" class="hover:underline">infuse.univ-amu.fr</a></h3>
      <p class="text-sm text-gray-600 mt-1">Academic research publishing with clean article layout — structured long-form, clear typography, strong editorial hierarchy. #report #academic #blog</p>
